...
namespace cagd
{
    ...
    public:
        ...
        GLboolean SetUniformVariableMatrix2f  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix3f  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix4f  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix2x3f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix2x4f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix3x2f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix3x4f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix4x2f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
        GLboolean SetUniformVariableMatrix4x3f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const;
