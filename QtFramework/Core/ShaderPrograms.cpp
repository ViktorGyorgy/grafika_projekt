...
GLboolean ShaderProgram::SetUniformVariableMatrix2f  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3f  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4f  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix2x3f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix2x4f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3x2f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3x4f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4x2f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4x3f(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
