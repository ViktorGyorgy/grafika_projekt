...
SecHypPatch3::SecHypPatch3(GLdouble u, GLdouble v):TensorProductSurface3(0.0, u, 0.0, v){
...
{
    if (u < 0.0 || u > _alpha[0] || v < 0.0 || v > _alpha[1] || maximum_order_of_partial_derivatives > 2)
        return GL_FALSE;
    ...
    d2_u_blending_values(0) = f0_2(_alpha[0], u);
    d2_u_blending_values(1) = f1_2(_alpha[0], u);
    d2_u_blending_values(2) = f2_2(_alpha[0], u);
    d2_u_blending_values(3) = f3_2(_alpha[0], u);

    d2_v_blending_values(0) = f0_2(_alpha[1], v);
    d2_v_blending_values(1) = f1_2(_alpha[1], v);
    d2_v_blending_values(2) = f2_2(_alpha[1], v);
    d2_v_blending_values(3) = f3_2(_alpha[1], v);
...
GLboolean SecHypPatch3::translateX(double value) {
...
// Option 1: Don't allow to translate
// Option 2: Figure the patch moving out
GLboolean SecHypPatch3::translateY(double value) {
...
GLboolean SecHypPatch3::translateZ(double value) {
...
GLvoid SecHypPatch3::SetImage(TriangulatedMesh3* image) {
    if (_image != nullptr) _image->DeleteVertexBufferObjects();
    _image = image;
    _image->UpdateVertexBufferObjects();
}

TriangulatedMesh3* SecHypPatch3::GetImage() { return _image; }

GLboolean SecHypPatch3::ExtendPatch(int dir, SecHypPatch3 &patch) {
...
GLboolean SecHypPatch3::ExtendNorth(SecHypPatch3 &patch) {
...
GLboolean SecHypPatch3::ExtendEast(SecHypPatch3 &patch) {
...
GLboolean SecHypPatch3::ExtendSouth(SecHypPatch3 &patch) {
...
GLboolean SecHypPatch3::ExtendWest(SecHypPatch3 &patch) {
...
GLboolean SecHypPatch3::ExtendNorthEast(SecHypPatch3 &patch) {
    DCoordinate3 p1;
    DCoordinate3 p2;
    DCoordinate3 p3;
    DCoordinate3 p4;
...
GLboolean SecHypPatch3::ExtendSouthEast(SecHypPatch3 &patch) {
    DCoordinate3 p1;
    DCoordinate3 p2;
    DCoordinate3 p3;
    DCoordinate3 p4;
...
GLboolean SecHypPatch3::ExtendSouthWest(SecHypPatch3 &patch) {
    DCoordinate3 p1;
    DCoordinate3 p2;
    DCoordinate3 p3;
    DCoordinate3 p4;
...
GLboolean SecHypPatch3::ExtendNorthWest(SecHypPatch3 &patch) {
    DCoordinate3 p1;
    DCoordinate3 p2;
    DCoordinate3 p3;
    DCoordinate3 p4;
...
double SecHypPatch3::GetTranslatedX() {
    return _translatedX;
}
double SecHypPatch3::GetTranslatedY() {
    return _translatedY;
}
double SecHypPatch3::GetTranslatedZ() {
    return _translatedZ;
}


GLboolean SecHypPatch3::SetUip(RowMatrix<GenericCurve3*>* uip) {
    if (_uip) {
...
GLboolean SecHypPatch3::SetVip(RowMatrix<GenericCurve3*>* vip) {
    if (_vip) {
...
RowMatrix<GenericCurve3*>* SecHypPatch3::GetUip() {
    return _uip;
}
RowMatrix<GenericCurve3*>* SecHypPatch3::GetVip() {
    return _vip;
}

GLboolean SecHypPatch3::SetNeighbour(int neighbour, int side, SecHypPatch3 *patch) {
...
/* ########## JOINING OF PATCHES  #################### */
GLboolean SecHypPatch3::JoinPatch(SecHypPatch3 &patch, int side1, int side2, SecHypPatch3 &result) {
    _has_neighbours = true;
    patch._has_neighbours = true;
...
GLboolean SecHypPatch3::JoinEastWest(SecHypPatch3 &patch, int side1, int side2, SecHypPatch3 &result) {
...
GLboolean SecHypPatch3::JoinNorthSouth(SecHypPatch3 &patch, int side1, int side2, SecHypPatch3 &result) {
    int p1_row1;
    int p1_row2;
...
GLboolean SecHypPatch3::JoinEastEast(SecHypPatch3 &patch, SecHypPatch3 &result) {
...
GLboolean SecHypPatch3::JoinWestWest(SecHypPatch3 &patch, SecHypPatch3 &result) {
...
GLboolean SecHypPatch3::JoinSouthSouth(SecHypPatch3 &patch, SecHypPatch3 &result) {
...
GLboolean SecHypPatch3::JoinNorthNorth(SecHypPatch3 &patch, SecHypPatch3 &result) {
...
GLboolean SecHypPatch3::JoinNorthEast(SecHypPatch3 &patch, SecHypPatch3 &result) {
    int p1_row1;
    int p1_row2;
...
GLboolean SecHypPatch3::JoinNorthWest(SecHypPatch3 &patch, SecHypPatch3 &result) {
    int p1_row1;
    int p1_row2;
...
GLboolean SecHypPatch3::JoinSouthWest(SecHypPatch3 &patch, SecHypPatch3 &result) {
    int p1_row1;
    int p1_row2;
...
GLboolean SecHypPatch3::JoinSouthEast(SecHypPatch3 &patch, SecHypPatch3 &result) {
    int p1_row1;
    int p1_row2;
...
GLboolean SecHypPatch3::MergePatch(SecHypPatch3 &patch, int side1, int side2) {
    _has_neighbours = true;
    patch._has_neighbours = true;
...
GLboolean SecHypPatch3::MergeEastWest(SecHypPatch3 &patch, int side1, int side2) {
    // Set the first column of the result to our last column
    // Set the last column of the result to the patch first column
    int p1_col1;
    int p1_col2;
...
GLboolean SecHypPatch3::MergeNorthSouth(SecHypPatch3 &patch, int side1, int side2) {
    int p1_row1;
    int p1_row2;
...
GLboolean SecHypPatch3::MergeEastEast(SecHypPatch3 &patch) {
    _neighbours[2] = &patch;
    _connected_side[2] = 2;
...
GLboolean SecHypPatch3::MergeWestWest(SecHypPatch3 &patch) {
    _neighbours[6] = &patch;
    _connected_side[6] = 6;
...
GLboolean SecHypPatch3::MergeNorthNorth(SecHypPatch3 &patch) {
    _neighbours[0] = &patch;
    _connected_side[0] = 0;
...
GLboolean SecHypPatch3::MergeSouthSouth(SecHypPatch3 &patch) {
    _neighbours[4] = &patch;
    _connected_side[4] = 4;
...
GLboolean SecHypPatch3::MergeNorthWest(SecHypPatch3 &patch) {
    _neighbours[0] = &patch;
    _connected_side[0] = 6;
...
GLboolean SecHypPatch3::MergeNorthEast(SecHypPatch3 &patch) {
    _neighbours[0] = &patch;
    _connected_side[0] = 2;
...
GLboolean SecHypPatch3::MergeSouthWest(SecHypPatch3 &patch) {
    _neighbours[4] = &patch;
    _connected_side[4] = 6;
...
GLboolean SecHypPatch3::MergeSouthEast(SecHypPatch3 &patch) {
    _neighbours[4] = &patch;
    _connected_side[4] = 2;
...
// 7. W
// 8. NW
GLvoid SecHypPatch3::PreserveContinuity(int row, int col, DCoordinate3 point) {
    if(_updated) return;
    _updated = true;
...
GLvoid SecHypPatch3::PreserveNorth(int row, int col, DCoordinate3 point) {
...
GLvoid SecHypPatch3::PreserveEast(int row, int col, DCoordinate3 point) {
...
GLvoid SecHypPatch3::PreserveSouth(int row, int col, DCoordinate3 point) {
...
GLvoid SecHypPatch3::PreserveWest(int row, int col, DCoordinate3 point) {
...
GLvoid SecHypPatch3::PreserveNorthEast(int row, int col, DCoordinate3 point) {

}
GLvoid SecHypPatch3::PreserveSouthEast(int row, int col, DCoordinate3 point) {

}
GLvoid SecHypPatch3::PreserveSouthWest(int row, int col, DCoordinate3 point) {

}
GLvoid SecHypPatch3::PreserveNorthWest(int row, int col, DCoordinate3 point) {

}

GLvoid SecHypPatch3::PreserveAlphaU(double u_alpha) {
...
GLvoid SecHypPatch3::PreserveAlphaV(double v_alpha) {
