...
public:
    ...
    void setupUi(QWidget *SideWidget)
    {
        ...
        toolBox->setGeometry(QRect(10, 290, 331, 761));
        toolBox->setInputMethodHints(Qt::ImhNone);
        page = new QWidget();
        page->setObjectName(QString::fromUtf8("page"));
        page->setGeometry(QRect(0, 0, 331, 691));
        ...
        page_2->setGeometry(QRect(0, 0, 331, 691));
        formLayoutWidget_2 = new QWidget(page_2);
        formLayoutWidget_2->setObjectName(QString::fromUtf8("formLayoutWidget_2"));
        formLayoutWidget_2->setGeometry(QRect(10, 10, 331, 675));
        ...
        groupBox_2->setGeometry(QRect(20, 1060, 311, 91));
